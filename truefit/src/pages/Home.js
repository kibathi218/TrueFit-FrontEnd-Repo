                ...
                <div className="container">
                    ...
                    <div className="row howto-space ">
                        <div className=" howto-card col">
                            <img className="howto-img" src="https://media.istockphoto.com/vectors/fresh-tasty-grilled-roasted-chicken-turkey-legs-with-vegetables-vector-id943483254?k=20&m=943483254&s=612x612&w=0&h=QcqcSxs0OA7BBdsSKkGB1rdA4aExrfPnqa0H14SgiVc=" />
                            <h2>Diet</h2>
                        ...
                        <div className=" howto-card col">
                            <img className="howto-img2" src="https://media.istockphoto.com/vectors/step-to-instruction-in-push-up-vector-id578104104?s=612x612" />
                            <h2>Exercise</h2>
                        ...
                        <div className=" howto-card col">
                            <img className="howto-img3" src="https://endorphitness.com/wp-content/uploads/2018/02/macros-1.png" />
                            <h2>Track</h2>
